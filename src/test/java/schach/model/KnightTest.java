...
class KnightTest {
    ...
    void scenarioWhite1() {
        ...
        Square e1 = testBoard.getSquare(5 , 6);
        Square e2 = testBoard.getSquare(3 , 6);
        Square e3 = testBoard.getSquare(5 , 2);
        Square e4 = testBoard.getSquare(3 , 2);
        Square em1 = testBoard.getSquare(6 , 5);
        Square em2 = testBoard.getSquare(6 , 3);
        Square em3 = testBoard.getSquare(2 , 5);
        Square em4 = testBoard.getSquare(2 , 3);
    ...
    void scenarioWhite2() {
        ...
        Knight1.updateLegals();
        List<Square> Actual =Knight1.getLegalNextSquares();
        Square enemy1a = testBoard.getSquare(5 , 6);
        Square enemy2a = testBoard.getSquare(3 , 6);
        Square enemy3a = testBoard.getSquare(5 , 2);
        Square enemy4a = testBoard.getSquare(3 , 2);
        Square empty1a = testBoard.getSquare(6 , 5);
        Square empty2a = testBoard.getSquare(6 , 3);
        Square empty3a = testBoard.getSquare(2 , 5);
        Square empty4a = testBoard.getSquare(2 , 3);
        List<Square> legals = new ArrayList<Square>();
        legals.add(enemy2a);
        legals.add(enemy1a);
        legals.add(empty1a);
