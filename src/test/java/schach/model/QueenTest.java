...
class QueenTest {
    ...
    void scenario1() {
        ...
        Square eny1 = testBoard.getSquare(6 , 6);
        Square eny2 = testBoard.getSquare(6 , 5);
        Square eny3 = testBoard.getSquare(6 , 4);
        Square eny4 = testBoard.getSquare(5 , 6);
        Square eny5 = testBoard.getSquare(5 , 4);
        Square eny6 = testBoard.getSquare(4 , 6);
        Square eny7 = testBoard.getSquare(4 , 5);
        Square eny8 = testBoard.getSquare(4 , 4);
