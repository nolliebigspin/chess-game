...
public class HomeScreen extends Pane {
	...
	@FXML
	private MenuItem humanVS;
	@FXML
	private MenuItem cpuVS;
	@FXML
	...
	@FXML
	private Menu instructor;
	@FXML
	private Menu languageMenu;
	@FXML
	private MenuItem englishMenu;
	@FXML
	private MenuItem germanMenu;
	@FXML
	...
	@FXML
    private Label whiteCemeteryLabel;
	@FXML
    private Label blackCemeteryLabel;
    ...
    private String addPlayer = "Add Player";
    private String player = "Player";
    private String playWith = "Play with";
    private String white = "White";
    private String black = "Black";
    private String lastMove = "Last Move";
    private String move = "Move";
    private String cemeteryString = "Cemetery";
	public HomeScreen() {
		try {
	...
	private void Human() {
		...
		dialog.setTitle(this.newGame);
		dialog.setHeaderText(this.addPlayer);
		...
		playerOne.setPromptText(this.player + " 1");
		TextField playerTwo = new TextField();
		playerTwo.setPromptText(this.player + " 2");
		grid.add(new Label( this.player+" 1:"), 0, 0);
		grid.add(playerOne, 1, 0);
		grid.add(new Label(this.player+" 2:"), 0, 1);
	...
	private void AI() {
		...
		grid.setPadding(new Insets(20, 150, 10, 10));
		TextField playerOne = new TextField();
		playerOne.setPromptText(this.player+" Name");
		ToggleGroup group = new ToggleGroup();
		RadioButton white = new RadioButton(this.white);
		RadioButton black = new RadioButton(this.black);
		black.setToggleGroup(group);
		white.setToggleGroup(group);
		grid.add(new Label(this.player+" Name:"), 0, 0);
		grid.add(playerOne, 1, 0);
		grid.add(new Label(this.playWith + ":"), 0, 1);
		grid.add(white, 1, 1);
		grid.add(black, 1, 2);
	...
	private void startGame() {
		...
		lastMove.getStyleClass().add(this.lastMove);
		...
		Label l = new Label(this.lastMove);
	...
	private void updateLastMove(){
		...
		TableColumn playerColum = new TableColumn(this.player);
		TableColumn move = new TableColumn(this.move);
//		move.setMinWidth(125);
		playerColum.setMinWidth(125);
		move.setMinWidth(125);
		table.getColumns().addAll(playerColum,move);
		table.getItems().addAll(new Label(this.white), new Label("e2-e3"));
	...
	this.startMenu.setText("START");
	this.newGameMenu.setText("New Game");
	this.humanVS.setText("Human VS Human");
	this.cpuVS.setText("Human VS CPU");
	this.loadGame.setText("Load Game");
	this.exitMenu.setText("Exit");
	this.settingMenu.setText("Setting");
	this.instructor.setText("instructor");
	this.languageMenu.setText("Language");
	this.englishMenu.setText("English");
	this.germanMenu.setText("German");
	this.howToPlayMenu.setText("How To Play");
	this.aboutMenu.setText("About");
	this.helpMenu.setText("Help");
	this.newGame = "New Game";
	this.addPlayer = "Add Player";
	this.player = "Player";
	this.playWith = "Play With";
	this.white = "White";
	this.black = "Black";
	this.whiteCemeteryLabel.setText("White Cemetery");
	this.blackCemeteryLabel.setText("Black Cemetery");
	...
	private void german(){
		this.startMenu.setText("START");
		this.newGameMenu.setText("Neu Spiel");
		this.humanVS.setText("Mensch VS Mensch");
		this.cpuVS.setText("Mensch VS CPU");
		this.loadGame.setText("Spiel Laden");
		this.exitMenu.setText("Beenden");
		this.settingMenu.setText("Einstellungen");
		this.instructor.setText("Instrukteur");
		this.languageMenu.setText("Sprache");
		this.englishMenu.setText("Englisch");
		this.germanMenu.setText("Deutsch");
		this.howToPlayMenu.setText("Spielanleitung");
		this.aboutMenu.setText("Info");
        this.helpMenu.setText("Hilfe");
        this.newGame = "Neu Spiel";
        this.addPlayer = "Spieler Hinzufügen";
        this.player = "Spieler";
        this.playWith = "Spiel Mit";
        this.white = "Weiß";
        this.black = "Schwarz";
        this.whiteCemeteryLabel.setText("Weiß Friedhof");
        this.blackCemeteryLabel.setText("Schwarz Friedhof");
        this.lastMove = "Letzte Zug";
	}
	...
	private void exit(){
		...
		System.exit(0);
			...
			Dialog<Pair<String, String>> dialog = new Dialog<>();
			dialog.setTitle("Close Game");
			dialog.setHeaderText("Are you sure?");
			dialog.getDialogPane().setStyle("-fx-background-color: #edfffc;");
			// Set the icon (must be included in the project).
			// Set the button types.
			ButtonType startButton = new ButtonType("Yes", ButtonData.OK_DONE);
			dialog.getDialogPane().getButtonTypes().addAll(startButton, ButtonType.CANCEL);

			Node loginButton = dialog.getDialogPane().lookupButton(startButton);
			Optional<Pair<String, String>> result = dialog.showAndWait();
			result.ifPresent(t->{System.exit(0);});
